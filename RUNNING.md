...
```bash
npm test               # 6 suites, 463 checks, ~6 seconds
...
| `test:features` — `scripts/features.test.mjs` | 160 | tailoring, letters, resume-parsing hygiene, posting intelligence, cross-role misattribution guard |
...
**53 + 30 + 126 + 18 + 160 + 76 = 463 checks, plus 132 end-to-end = 595.** Current tree: all green
